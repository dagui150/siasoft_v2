...
class Cliente extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		...
		return array(
			...
			'RUBRO1_FA' => $conf_fa->USAR_RUBROS && $conf_fa->RUBRO1_NOMBRE != '' ? $conf_fa->RUBRO1_NOMBRE : 'Rubro 1',
			'RUBRO2_FA' => $conf_fa->USAR_RUBROS && $conf_fa->RUBRO2_NOMBRE != '' ? $conf_fa->RUBRO2_NOMBRE : 'Rubro 2',
			'RUBRO3_FA' => $conf_fa->USAR_RUBROS && $conf_fa->RUBRO3_NOMBRE != '' ? $conf_fa->RUBRO3_NOMBRE : 'Rubro 3',
			'RUBRO4_FA' => $conf_fa->USAR_RUBROS && $conf_fa->RUBRO4_NOMBRE != '' ? $conf_fa->RUBRO4_NOMBRE : 'Rubro 4',
			'RUBRO5_FA' => $conf_fa->USAR_RUBROS && $conf_fa->RUBRO5_NOMBRE != '' ? $conf_fa->RUBRO5_NOMBRE : 'Rubro 5',
			'RUBRO1_CC' => 'Rubro1 Cc',
			'RUBRO2_CC' => 'Rubro2 Cc',
			'RUBRO3_CC' => 'Rubro3 Cc',
			'RUBRO4_CC' => 'Rubro4 Cc',
