        ...
        public function behaviors()
	{
		...
		return array(
                        'defaults'=>array(
                           ...
                           'formats'=> array(
                                   'EXISTENCIA_MINIMA'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'EXISTENCIA_MAXIMA'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'PUNTO_REORDEN'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'VOLUMEN'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'FACTOR_EMPAQUE'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'FACTOR_VENTA'=>'###,##0.'.str_repeat('0',isset($conf->EXISTENCIAS_DEC)?$conf->EXISTENCIAS_DEC:'2'), 
                                   'PESO_NETO'=>'###,##0.'.str_repeat('0',isset($conf->PESOS_DEC)?$conf->PESOS_DEC:'2'), 
                                   'PESO_BRUTO'=>'###,##0.'.str_repeat('0',isset($conf->PESOS_DEC)?$conf->PESOS_DEC:'2'), 
                                   'COSTO_PROMEDIO'=>'###,##0.'.str_repeat('0',isset($conf->COSTOS_DEC)?$conf->COSTOS_DEC:'2'),
                                   'COSTO_ESTANDAR'=>'###,##0.'.str_repeat('0',isset($conf->COSTOS_DEC)?$conf->COSTOS_DEC:'2'),
                                   'COSTO_ULTIMO'=>'###,##0.'.str_repeat('0',isset($conf->COSTOS_DEC)?$conf->COSTOS_DEC:'2'),
                                   'PRECIO_BASE'=>'###,##0.'.str_repeat('0',isset($conf->COSTOS_DEC)?$conf->COSTOS_DEC:'2'),
                            ),
                        ),
