...
<?php
    ...
    $fechaFactura = $this->darCalendario($model, 'FECHA_PEDIDO', null);
    $fechaDespacho = $this->darCalendario($model, 'FECHA_PROMETIDA', null);
    $fechaEntrega = $this->darCalendario($model, 'FECHA_EMBARQUE', null);
