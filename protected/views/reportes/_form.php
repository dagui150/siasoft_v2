            ...
            <td>
                <?php switch ($tipo){
                    ...
                    <tr>
                        <td>
                            <div style="margin-left: -63px">
                                <?php echo $form->label($model,'CONSECUTIVOS_FA',array('class'=>'control-label'));?>
                                <div class="controls">
                                     <?php 
                                        $this->widget('ext.chosen.Chosen',array(
                                            'model' => $model,
                                            'attribute' =>'CONSECUTIVOS_FA',
                                            'multiple' =>true,
                                            'noResults' =>'No hay resultados',
                                            'placeholderMultiple'=>'Seleccione...',
                                            'htmlOptions' => array('style'=>'width:350px; !important'), 
                                            'data' => CHtml::listData(ConsecutivoFa::model()->findAllByAttributes(array('ACTIVO'=>'S')),'CODIGO_CONSECUTIVO','DESCRIPCION'),
                                         ));
                                    ?>
                                </div>
                            </div>
