...
<div class="form">
    ...
    <?php if ($model2->isNewRecord): ?>
        ...
        <?php if (!$model2->isNewRecord): ?>
            ...
            <?php $this->widget('bootstrap.widgets.TbButton', array('label' => 'Cancelar', 'size' => 'small', 'url' => array('/tipoAccidente/admin'), 'icon' => 'remove', 'htmlOptions' => array('data-dismiss' => 'modal'))); ?>	        
        </div>
